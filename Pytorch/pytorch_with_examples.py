...
# about deep learning or gradients or computational graphs, and is just a 
# way to perform generic numeric computations
...
# a PyTorch Tensor can run on either CPU or GPU. To run operations on the 
# GPU, just cast the Tensor to a cuda datatype.
...
##################################################
###     Part 3 : PyTorch Tensors And Autograd  ###
##################################################
...
# If x is a Tensor that has x.requires_grad=True then x.grad is 
# another Tensor holding the gradient of x with respect to 
# some scalar value.
...
##############################################################
###     Part 4 : PyTorch Defining New autograd Functions  ###
##############################################################
...
#This implementation computes the forward pass using operations on 
# PyTorch Variables, and uses PyTorch autograd to compute gradients.

#n this implementation we implement our own custom autograd function 
# to perform the ReLU function.
...
##############################################
###     Part 5 : TensorFlow Static Graphs  ###
##############################################

#A fully-connected ReLU network with one hidden layer and no biases, 
# trained to predict y from x by minimizing squared Euclidean distance.

#This implementation uses basic TensorFlow operations to set up a 
# computational graph, then executes the graph many times to actually 
# train the network.

#One of the main differences between TensorFlow and PyTorch is that 
# TensorFlow uses static computational graphs while PyTorch uses dynamic 
# computational graphs.

#In TensorFlow we first set up the computational graph, then execute 
# the same graph many times.
...
###############################################
###     Part 8 : PyTorch Custum NN Modules  ###
###############################################
...
###########################################################
###     Part 9 : PyTorch Control Flow + Weight Sharing  ###
###########################################################
